...
describe('Full House', (): void => {
  ...
  describe('evaluate full house', (): void => {
    it('should return full house 1 and high card rank 2', (): void => {
      expect(
    ...
    it('should return full house rank 1 and one pair rank 2', (): void => {
      expect(
        pokerService.evaluate([
          {
            cards: [
    ...
    it('should return full house rank 1 and three of a kind rank 2', (): void => {
      expect(
        pokerService.evaluate([
          {
            cards: [
    ...
    it('should return full house rank 1 and full house rank 2', (): void => {
      expect(
        pokerService.evaluate([
          {
            cards: [
