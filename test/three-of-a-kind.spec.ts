...
describe('Three Of A Kind', (): void => {
  ...
  describe('evaluate three of a kind', (): void => {
    ...
    it('should return three of a kind rank 1 and one pair rank 2', (): void => {
      expect(
        pokerService.evaluate([
          {
            cards: [
    ...
    it('should return three of a kind rank 1 and three of a kind rank 2', (): void => {
      expect(
        pokerService.evaluate([
          {
            cards: [
